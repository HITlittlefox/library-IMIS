...
<html>
    ...
    <body>
        <h2>处理上传的文件：jpg,gif,jpeg,png</h2>
        <hr>
        <%
...
//                    file.saveAs("C:/Users/96361/Workspaces/MyEclipse CI/MyJ2EEWeb/upload/" + rndFilename, myupload.SAVE_PHYSICAL);
                    ...
                    String sql_restore_path_for_photos = "upload/" + rndFilename;

                    String pic_insert = "INSERT INTO pictures (pic_name, restore_path) VALUES ('" + rndFilename + "', '" + sql_restore_path_for_photos + "')";
